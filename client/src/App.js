...
function App() {
	const [ showModal, setShowModal, , setShowModalFalse ] = useToggle(false);

    return (
        <div className="App h-full w-full lg:h-screen lg:w-screen text-white">
			<Navbar setShowModal={ setShowModal }/>
			<section className="divide-y divide-solid divide-pink-200" onClick={ setShowModalFalse }>
